...
LOCAL aSamples := { ;
   ...
   MENU
      MENUITEM "Fine" ACTION hd_MsgYesNo( "Vuoi Uscire ?", {|o|Iif(o:nres==1,hd_calljava_s_v("exit:"),.t.)} )
   ENDMENU
   oWnd:bBack := {|| hd_MsgYesNo( "Vuoi Uscire ?", {|o|Iif(o:nres==1,hd_calljava_s_v("finish:"),.t.)} ) }

   BEGIN LAYOUT oLayV SIZE MATCH_PARENT,MATCH_PARENT

   TEXTVIEW oText0 TEXT "Mastro Demo" TEXTCOLOR "#FFD700" BACKCOLOR "#255779" SIZE MATCH_PARENT,32
